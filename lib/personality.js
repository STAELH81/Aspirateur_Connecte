      ...
      .addFields(
        {
          ...
          value: [
            ...
            "**Quetes** — hub quetes & coop (v1.2.8.5, voir ci-dessous)",
            "**Infos** — guide gambling complet",
          ].join("\n"),
        },
        {
          name: "Quetes Center (salon quetes)",
          value: [
            "Tableau 🟢🟠🔴⚫ par membre (Quete + Coop).",
            "**Quetes du jour** · **Coop du jour** · **Infos quotidiennes** · **Refresh**",
            "Quete du jour : progression auto (daily, work, casino…).",
            "**Serie** : claim plusieurs jours → bonus jusqu'a **+21** coins.",
            "Coop : **100** parties serveur/jour → **+25** si joue avant le cap.",
            "Coop ⚫ = objectif atteint trop tard pour toi.",
            "Rappel DM **20h** · maj auto panneau ~**10 s**.",
          ].join("\n"),
        },
        {
        ...
        },
        {
          ...
          value: [
            ...
            "`/money admin donner|retirer` · `/quests panel|refresh`",
