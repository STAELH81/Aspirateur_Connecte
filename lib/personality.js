    ...
    new EmbedBuilder()
      ...
      .addFields(
        ...
        },
        {
          name: "AFK & niveaux (XP)",
          value: [
            "`/afk on [raison]` — mode AFK (ping = statut)",
            "`/afk off` — desactive AFK",
            "`/level voir [membre]` — niveau + barre XP",
            "`/level top` — classement XP",
            "Ecrire des messages = XP (1 gain / ~60 s), level up annonce",
          ].join("\n"),
        },
        {
      ...
      .addFields(
        {
          ...
          value: [
            ...
            "`shop` — acheter un role temporaire (si boutique configuree)",
