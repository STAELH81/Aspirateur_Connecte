      ...
      .addFields(
        {
          ...
          value: [
            ...
            "**Casino** — jeux via menu + Meme mise / Rejouer",
            "**Quetes** — tableau, Claim quete/coop, **Ma quete**, Refresh, serie bonus",
            "**Infos** — guide gambling (ce panneau)",
          ].join("\n"),
        },
        {
          name: "Quetes & coop",
          value: [
            "Quete du jour : progression auto (daily, work, casino…).",
            "**Serie quetes** : claim plusieurs jours d'affilee → bonus jusqu'a **+21** coins.",
            "Coop : **30** parties casino serveur/jour → **+25** coins si tu as joue avant le cap.",
            "Annonce coop dans **#casino** · claim sur panneau **Quetes** (2 boutons separes).",
            "Rappel DM **20h** si quete ou coop oubliee.",
            "`/quests panel|refresh` — staff · salon `QUESTS_BOARD_CHANNEL_ID`",
          ].join("\n"),
        },
        {
          name: "/money admin · /casino · staff",
          value: [
            "`/money admin panel|shop-panel|infos-panel|casino-panel` — poster panneaux",
            "`/money admin donner|retirer` — gerer les coins",
            "`/gazette test|preview` — recap casino 23h59",
            "`/dashboard sync` — stats site Netlify",
            "`/botstatus` — etat bot & .env",
            "`/casino` — lancer une partie",
