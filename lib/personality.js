      ...
      .addFields(
        {
          ...
          value: [
            "**Bank** — balance, pay, profil, banque, top 25",
            "**Money** — daily, work, quetes, coop, tableau live",
        ...
        {
          name: "Money Center (salon #money)",
          value: [
            "Colonnes : **daily · work · quest · coop** (🟢 fait · 🔴 pas encore).",
            "**Daily** · **Work** · **Quetes du jour** · **Coop du jour** · **Infos** · **Refresh**",
            "Msgs bleus ephemeres : auto-suppr. ~**5 min**.",
            "Coop ⚫ = trop tard · serie quetes jusqu'a **+21** bonus.",
          ].join("\n"),
        },
        {
