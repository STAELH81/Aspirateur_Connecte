...
function infosPanelEmbed() {
  ...
  if (profile.isRockAndRoll()) {
    return new EmbedBuilder()
      ...
      .setDescription(
        [
          "**Salons** : **Banque** · **Money** · **Casino** · **Infos**",
      ...
      .addFields(
        ...
        },
        {
          name: "Coop & duels",
          value: [
            `**${coopGoalGames}** parties / jour → **+25** coins (jouer avant le cap).`,
            `Duels : manche = 1 partie coop (max **${coopGoal.DUEL_COOP_MAX_ROUNDS_PER_DUEL}**/duel, mise min **${coopGoal.DUEL_COOP_MIN_BET}**).`,
          ].join("\n"),
        },
        {
          name: "Roles jeux",
          value: "Staff : `/roles menu:jeux` — boutons **CS2** · **Clips** · **Valo**.",
        }
      );
  }
  ...
  return new EmbedBuilder()
    .setColor(COLOR_UI)
    .setTitle("Guide gambling — Les Girlsss (v1.2.10)")
    .setDescription(
      [
