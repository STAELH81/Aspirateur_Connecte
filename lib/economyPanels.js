...
function infosPanelEmbed() {
  ...
  return new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: "Quetes Center (v1.2.8)",
        value: [
          "Salon **quetes** : panneau fixe avec tableau 🟢🟠🔴 (Quete + Coop par membre).",
          "**Claim quete** — quand l'objectif du jour est fini (+ **serie** : bonus jusqu'a **+21**).",
          "**Claim coop** — bonus commu **+25** si eligible.",
          "**Ma quete** — ton suivi perso (quete, coop, serie).",
      ...
      },
      {
        ...
        value: [
          "**30** parties casino sur le serveur / jour → **+25** coins.",
          "Tu dois avoir joue **avant** le cap — pas apres.",
